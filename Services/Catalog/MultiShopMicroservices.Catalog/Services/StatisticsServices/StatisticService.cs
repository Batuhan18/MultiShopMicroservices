...
namespace MultiShopMicroservices.Catalog.Services.StatisticsServices
{
    public class StatisticService : IStatisticService
    {
        ...
        public StatisticService(IDatabaseSettings _databaseSettings)
        {
            ...
            _brandCollection = database.GetCollection<Brand>(_databaseSettings.CategoryCollectionName);
        }
