    ...
    public partial class mig1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CargoCompanyies", x => x.CargoCompanyId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CargoDetails_CargoCompanyies_CargoCompanyId",
                        column: x => x.CargoCompanyId,
                        principalTable: "CargoCompanyies",
