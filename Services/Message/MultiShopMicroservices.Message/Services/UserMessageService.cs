...
using MultiShopMicroservices.Message.DAL.Context;
using MultiShopMicroservices.Message.DAL.Entities;
using MultiShopMicroservices.Message.Dtos;

namespace MultiShopMicroservices.Message.Services
{
    public class UserMessageService : IUserMessageService
    {
        ...
        public async Task CreateMessageAsync(CreateMessageDto createMessageDto)
        {
            ...
            await _messageContext.AddAsync(value);
